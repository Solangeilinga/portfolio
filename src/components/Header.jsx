        ...
        <motion.header initial={{ y: -20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="fixed w-full z-30">
            <div className="backdrop-blur-sm bg-surface">
                <div className="container mx-auto px-4 flex items-center justify-between h-16">
                    <a href="#home" className="text-xl font-bold bg-gradient-to-r from-indigo-400 to-fuchsia-400 bg-clip-text text-transparent">
                        Solange ILINGA
                    </a>
                    ...
                    <nav className="hidden md:flex gap-6">
                        {nav.map(n => (
                            ...
                            >
                                {n.label}
                                {activeSection === n.id && (
                                    <div className="h-0.5 bg-gradient-to-r from-indigo-400 to-fuchsia-400 rounded-full mt-1" />
                                )}
                            </a>
                        ))}
                    </nav>

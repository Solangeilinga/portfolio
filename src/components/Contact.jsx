                        ...
                        <div className="mt-8">
                            ...
                            <div className="flex space-x-4">
                                <a
                                    ...
                                    className="bg-gray-700 hover:bg-blue-600 p-3 rounded-full transition-colors flex items-center justify-center"
                                    aria-label="LinkedIn"
                                >
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="bg-gray-700 hover:bg-gray-600 p-3 rounded-full transition-colors flex items-center justify-center"
                                    aria-label="GitHub"
                                >
                        ...
                        <form ref={form} onSubmit={handleSubmit} className="space-y-4">
                            ...
                            {success === true && (
                                <div className="mt-4 p-3 bg-green-900/30 border border-green-800 rounded-lg">
                                    <p className="text-green-400 text-center">Merci ! Votre message a été envoyé avec succès.</p>
                                </div>
                            )}
                            {success === false && (
